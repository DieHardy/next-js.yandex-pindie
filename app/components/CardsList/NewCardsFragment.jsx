  ...
  return (
    <>
      <li className={Styles["cards-list__item"]}>
        <a href="/game-id.html" className={Styles["cards-list__link"]}>
          <article className={Styles.card}>
            ...
            <div className={Styles["card__content-block"]}>
              <h3 className={Styles["cards__title"]}>Go Away</h3>
      ...
      <li className={Styles["cards-list__item"]}>
        <a href="/game-id.html" className={Styles["cards-list__link"]}>
          <article className={Styles.card}>
            ...
            />
            <div className={Styles["card__content-block"]}>
              <h3 className={Styles["cards__title"]}>G.U.N.N.E.R.</h3>
              <p className={Styles["card__description"]}>
      ...
      <li className={Styles["cards-list__item"]}>
        <a href="/game-id.html" className={Styles["cards-list__link"]}>
          <article className={Styles.card}>
            ...
            />
            <div className={Styles["card__content-block"]}>
              <h3 className={Styles["cards__title"]}>Space Terror</h3>
              <p className={Styles["card__description"]}>
      ...
      <li className={Styles["cards-list__item"]}>
        <a href="/game-id.html" className={Styles["cards-list__link"]}>
          <article className={Styles.card}>
            ...
            />
            <div className={Styles["card__content-block"]}>
              <h3 className={Styles["cards__title"]}>Square Slayer</h3>
              <p className={Styles["card__description"]}>
